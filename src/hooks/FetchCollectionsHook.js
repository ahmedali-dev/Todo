...
export const FetchCollectionItem = (props) => {
    ...
    const FetchData = async () => {
        props.loading(true);
        const url = `https://ToDo.ahmedali-dev.repl.co/collections/${props.id}`;
        const request = await fetch(
            url,
            {
                method: 'POST',
...
export const AddCollectionItems = (props) => {
    ...
    const FetchData = async () => {
        props.loading(true);
        const url = `https://ToDo.ahmedali-dev.repl.co/collections/${props.id}/add`;
        const request = await fetch(
            url,
            {
                method: 'POST',
...
export const UpdateCollectionItem = (props) => {
    ...
    const FetchData = async (id, collid) => {
        props.loading(true);
        const url = `https://ToDo.ahmedali-dev.repl.co/collections/${collid}/update`;
        const request = await fetch(
            url,
            {
                method: 'POST',
...
export const FetchAccountData = (props) => {
    ...
    const FetchData = async () => {
        props.loading(true);
        const url = `https://ToDo.ahmedali-dev.repl.co/account`;
        const request = await fetch(
            url,
            {
                method: 'POST',
...
export const UpdateAccountData = (props) => {
    ...
    const FetchData = async (name, email, image) => {
        ...
        props.loading(true);
        const url = `https://ToDo.ahmedali-dev.repl.co/account/update`;
        ...
        if (response.status !== 200) {
            ...
            dispatch(SignUpAction({token: response.token, userImage: response.userImage}))
            setTimeout(() => {
